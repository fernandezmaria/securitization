...
from joysticksecuritizatiotl3swp.config import get_params_from_config
...
def main():
    ...
    try:
        ...
        if os.path.isfile(dataflow_path):
            ...
            from joysticksecuritizatiotl3swp.dataflow import dataproc_dataflow
            dataproc_dataflow.run_dataproc(**parameters)
            logger.info("Dataflow code executed")
        else:
            logger.info("Executing experiment code")
            from joysticksecuritizatiotl3swp.app import DataprocExperiment
